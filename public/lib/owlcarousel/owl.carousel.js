...
(function ($, window, document, undefined) {
        ...
        },
        {
            ...
            run: function (cache) {
                ...
                while (iterator--) {
                    ...
                    merge =
                        (this.settings.mergeFit && Math.min(merge, this.settings.items)) || merge;
    ...
    Owl.prototype.coordinates = function (position) {
        ...
        if (this.settings.center) {
            ...
            coordinate +=
                ((this.width() - coordinate + (this._coordinates[newPosition] || 0)) / 2) *
                multiplier;
        } else {
        ...
        content
            ...
            .each(
                $.proxy(function (index, item) {
                    ...
                    this._mergers.push(
                        item.find("[data-merge]").addBack("[data-merge]").attr("data-merge") * 1 ||
                            1,
                    );
                }, this),
            );
...
(function ($, window, document, undefined) {
    ...
    var Lazy = function (carousel) {
         ...
         */
        this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": $.proxy(function (
                e,
            ) {
                if (!e.namespace) {
                    return;
...
(function ($, window, document, undefined) {
    ...
    Navigation.prototype.initialize = function () {
        ...
        if (!settings.dotsData) {
            this._templates = [
                $("<div>").addClass(settings.dotClass).append($("<span>")).prop("outerHTML"),
            ];
        }
